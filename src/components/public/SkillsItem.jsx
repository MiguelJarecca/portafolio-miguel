...
export default function SkillsItem({arrayIcons, backendIcons, othersIcons}) {
  ...
  <div key={index} className={backItem.clase}><FontAwesomeIcon icon={backItem.icono}/></div>)    

  let othersItems = othersIcons.map((otherItem, index) => 
  <div key={index} className={otherItem.clase}><FontAwesomeIcon icon={otherItem.icono}/></div>)
